...
function handleSettings(res: http.ServerResponse): void {
  ...
  // "Toolcall model" row writes. Mercury and Oculus have their OWN model + ctx
  // rows and keys (mercury:model / oculus:model / local:mercury_ctx /
  // local:oculus_ctx), mirrored into the same fields below.
